...
import { Screen, Card, EmptyState, LoadingScreen, SegmentedControl } from '@/components/ui';
  ...
  return (
    <Screen>
      ...
      <FlatList
        ...
        ListEmptyComponent={<EmptyState message="No expenses logged for this view yet. Tap + to add one." />}
        renderItem={({ item }) => (
